...
{
    public partial class PromotionRulesAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductRelationNumber = table.Column<int>(type: "INTEGER", nullable: false),
                    Quantity = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromotionRuleItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PromotionRuleItems_Promotions_PromotionId",
                        column: x => x.PromotionId,
                        principalTable: "Promotions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PromotionRuleItems_Sizes_SizeId",
                        column: x => x.SizeId,
                        principalTable: "Sizes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PromotionRuleItemId = table.Column<int>(type: "INTEGER", nullable: false),
                    ProductId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PromotionRuleProducts_PromotionRuleItems_PromotionRuleItemId",
                        column: x => x.PromotionRuleItemId,
                        principalTable: "PromotionRuleItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionRuleItems_PromotionId",
                table: "PromotionRuleItems",
                column: "PromotionId");

            migrationBuilder.CreateIndex(
                name: "IX_PromotionRuleItems_SizeId",
                table: "PromotionRuleItems",
                column: "SizeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionRuleProducts_PromotionRuleItemId",
                table: "PromotionRuleProducts",
                column: "PromotionRuleItemId");
