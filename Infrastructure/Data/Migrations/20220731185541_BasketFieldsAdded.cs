...
{
    public partial class BasketFieldsAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasePrice = table.Column<double>(type: "REAL", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Doughs_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BasketProducts_Doughs_DoughId",
                        column: x => x.DoughId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasketIngredients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BasketIngredients_BasketProducts_BasketProductId",
                        column: x => x.BasketProductId,
                        principalTable: "BasketProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BasketIngredients_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketIngredients_BasketProductId",
                table: "BasketIngredients",
                column: "BasketProductId");

            migrationBuilder.CreateIndex(
                name: "IX_BasketIngredients_IngredientId",
                table: "BasketIngredients",
                column: "IngredientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketProducts_DoughId",
                table: "BasketProducts",
                column: "DoughId");
